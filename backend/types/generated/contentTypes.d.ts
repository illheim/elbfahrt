...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "A passenger's seat reservation on a specific ride (or specific date for recurring rides).";
    displayName: 'Booking';
    pluralName: 'bookings';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    instance_date: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::booking.booking'
    ...
    status: Schema.Attribute.Enumeration<
      ['confirmed', 'cancelled_by_passenger', 'cancelled_by_driver']
    > &
      Schema.Attribute.Required &
...
export interface ApiDriverSettingsDriverSettings
  extends Struct.SingleTypeSchema {
  collectionName: 'driver_settings';
  info: {
    description: 'Site-wide driver-onboarding policy. Edit in Strapi admin \u2192 Content Manager \u2192 Single Types.';
    displayName: 'Driver Settings';
    pluralName: 'driver-settings-plural';
    singularName: 'driver-settings';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    auto_approve_drivers: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::driver-settings.driver-settings'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiRideRequestRideRequest extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A ride request posted by a passenger seeking a driver.';
    displayName: 'Ride Request';
    pluralName: 'ride-requests';
    singularName: 'ride-request';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    departure_at: Schema.Attribute.DateTime & Schema.Attribute.Required;
...
export interface ApiRideRide extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A ride offered by a driver (one-off or recurring).';
    displayName: 'Ride';
    pluralName: 'rides';
    singularName: 'ride';
  };
  ...
  attributes: {
    ...
    recurrence_weekdays: Schema.Attribute.JSON;
    return_at: Schema.Attribute.DateTime;
    route_distance_m: Schema.Attribute.Integer;
    route_duration_s: Schema.Attribute.Integer;
    seats_total: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          max: 8;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    driver_id_type: Schema.Attribute.Enumeration<
      ['personalausweis', 'fuehrerschein']
    >;
    driver_status: Schema.Attribute.Enumeration<
      ['pending_review', 'approved', 'rejected']
    >;
    driver_verified_at: Schema.Attribute.DateTime;
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
    ...
    parent_first_name: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    parent_last_name: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    parent_mobile: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 30;
      }>;
    password: Schema.Attribute.Password &
    ...
    publishedAt: Schema.Attribute.DateTime;
    resetPasswordToken: Schema.Attribute.String & Schema.Attribute.Private;
    ride_requests: Schema.Attribute.Relation<
      'oneToMany',
      'api::ride-request.ride-request'
    >;
    rides_offered: Schema.Attribute.Relation<'oneToMany', 'api::ride.ride'>;
    role: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.role'
    >;
